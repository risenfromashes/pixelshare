...
<div class="flex h-screen bg-gray-900">
  ...
  <!-- Main Content -->
  <div class="flex-1 xl:px-32 px-4 py-8 overflow-y-auto bg-orange-50 text-black">
    ...
    <div class="flex justify-between items-start mb-5">
      ...
      <div class="flex  relative">
        <div class="relative w-24 h-24">
          <img src={$profileImage} alt="Profile Picture" class="rounded-full w-24 h-24 border-4 border-white">
          <label for="profile-image-input" class="cursor-pointer absolute bottom-0 right-0">
              <img src="./icons/camera.png" alt="File Picker" class="w-10 h-10 p-2 bg-white-300 rounded-full">
          </label>
          <input
              type="file"
    ...
    <div class="mb-12 mt-16 relative">
      ...
      <div class="relative">
        <p id="aboutText" class="bg-orange-100 p-2.5 rounded-md w-full relative">
          {user.about}
          <a href="#" id="editButton" class="absolute bottom-6 right-0 mr-1 mt-2 cursor-pointer">
            <img src="./icons/edit.png" class="w-5 h-5 border-1 border-white" on:click={openModal}>
    ...
    <div class="fixed inset-0 flex items-center justify-center z-50">
        <div class="modal bg-orange-200 rounded-lg p-6">
            ...
            <textarea class="w-full h-32 rounded border p-2 mb-4 bg-orange-100" placeholder="Type your message here"></textarea>
  ...
  <div class="mb-5">
    ...
    <div class="bg-orange-300  gap-4  mb-2 w-full h-px mx-3"></div>
      <div class="flex flex-wrap gap-4 mb-2">
        ...
        <div class="bg-orange-100 p-2.5 rounded-lg w-1/5 hover:bg-orange-200 transition duration-300 ease-in-out">
          <!-- Content -->
