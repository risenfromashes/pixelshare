			...
			<div class="flex flex-col space-y-4">
				...
				{:else}
					{#each data.requests as request}
						<form
							class="request-item flex items-center bg-orange-100 border-2 border-orange-200 p-4 rounded-lg shadow-lg hover:bg-orange-200 transition-colors duration-200 ease-in-out"
						>
							<!-- Member Picture -->
